            ...
            <div class="w-4/6 pr-4 overflow-auto ">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pr-20 ">
                        ...
                        <!--  <button class="absolute p-2 mt-3 rounded-full z-2 top-6">
                         ...
                         <button class="absolute p-2 pr-14 bg-gradient-to-r from-white to-transparent z-2 top-6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 1024 1024"
                                class="h-4 mt-3 ">
                                <path fill="currentColor"
                    ...
                    <div
                        class="flex pt-10 mx-14 overflow-x-auto gap-x-12 border-b-[1px] scroll-container border-b-slate-400">
                        <div v-for="(tag, index) in tagNames" :key="index" class=" whitespace-nowrap">
                            <button class="px-2 mx-2">{{ tag }}</button>
                        </div>
                        <div class="absolute inset-y-0 right-0">
                            ...
                            <button class="absolute right-0 p-2 pl-14 z-2 bg-gradient-to-l from-white to-transparent top-6">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 1024 1024"
                                    class="h-4 mt-3">
                                    <path fill="currentColor"
