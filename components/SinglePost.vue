...
const props = defineProps<SinglePost>()
...
<template>
        ...
        <div class="pt-6 pb-4 ">
            ...
            <div class="py-6">
                ...
                <div class="flex py-4 align-middle gap-x-4">
                    <img :src="(author?.profilePicture?.url as string)" :alt="author?.name"
                    ...
                    <div>
                        ...
                        <div class="flex gap-x-2">
                            <p class="font-thin">{{ readingTime }} mins
                                read</p>
                            <span>•</span>
            ...
            <button class="h-15 p-3 justify-center text-black bg-[#f2f2f2] rounded-full w-30">{{ tag }}</button>
    ...
    <div class="bg-[#e8e8e8] w-[100%] pt-12">
        <div class=" items-center justify-start px-[20%] gap-x-2 ">
            <div class="mb-2">
                <img :src="author?.profilePicture?.url ?? ''" :alt="author?.name"
            ...
            <div class="flex gap-x-6 border-y-[1px] border-gray-200 py-2">
                ...
                <div class="flex w-4/6 gap-x-6">
                    <div class=" gap-y-2">
                        <p class="text-xl font-bold">Written by {{ author?.name }}</p>
                        <div class="flex gap-x-2">
                            <p>{{ author?.followers }} Followers</p>
                            <span>•</span>
                            <p class="font-thin">{{ author?.positionRole }}</p>
                        </div>
                        <p>{{ author?.bio }}</p>
                    </div>
                </div>
