    ...
    <div class="p-4 pt-6 ">
        ...
        <div class="pb-4 pt-6 border-b-[1px] border-b-gray-200">
            ...
            <div class="flex py-2 gap-x-2">
                <img src="../public/img/staffUser1.png" alt="Picasso propic" class="w-6 h-6 rounded-full" />
                <p>Pablo Picasso</p>
                <span>•</span>
                <p>Nov 10, 2023</p>
            </div>
            ...
            <div class="grid grid-cols-4 grid-rows-3 gap-2">
                ...
                <p class="col-span-3 row-span-1 line-clamp-2">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos ad ipsum voluptatum hic repellendus id
                    ipsa
                    deserunt, eaque explicabo neque autem iure magni ipsam soluta, numquam maxime. Explicabo, veniam
                    nihil?
                    Provident, reiciendis culpa magnam ducimus voluptatem placeat at voluptatibus quibusdam expedita
                    ipsum
                    blanditiis libero ut dolorem saepe maxime ex molestias veritatis similique ea commodi nesciunt neque
                    corrupti assumenda adipisci. Dolor!
                </p>
                <div class="col-span-3 row-span-1 py-2 ">
                    <div class="flex">
                        <div class="flex items-center justify-start w-3/4 gap-x-4">
                            <button class="px-2 bg-gray-400 rounded-full">Node.js</button>
                            <p>5 min read</p>
                        </div>
